...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      ...
      <p style="margin: 0px 0px 0px 0px;"><a class="navbar-brand" href="${pageContext.request.contextPath}/user/login" style="font-size: 15px; text-decoration: underline; margin-right: 0px;"><i class="fas fa-user-alt"></i> 마이페이지</a></p>
