    ...
    <form:form modelAttribute="signupDto" id="signupForm" method="post" action="${pageContext.request.contextPath}/user/signup">
      ...
      <div class="card" style="border: none; margin-bottom: 40px; font-weight: 800;">
        ...
        <div class="control-group">
			<div class="form-group floating-label-form-group controls">
              	<label>비밀번호</label>
              	<form:input type="text" cssClass="form-control" placeholder="비밀번호" id="userPwd" path="userPwd"/>
		...
		<div class="control-group">
			<div class="form-group floating-label-form-group controls">
				<label>전화번호</label>
				<form:input type="text" cssClass="form-control" placeholder="전화번호" id="userPhone" path="userPhone"/>
